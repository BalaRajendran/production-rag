        ...
        for pattern in metadata_patterns:
            if re.search(pattern, query_lower):
                return (
                    ...
                    "Query is about document metadata"
                )
...
"""
        ...
        try:
            ...
            # Map to QueryType
            if category == "RAG":
                return QueryType.RAG, explanation
            elif category == "SUMMARIZATION":
                return QueryType.SUMMARIZATION, explanation
            elif category == "METADATA_QUERY":
                return QueryType.METADATA_QUERY, explanation
            else:
                return QueryType.GENERAL, explanation

        except Exception as e:
            print(f"Error in LLM-based routing: {e}")
